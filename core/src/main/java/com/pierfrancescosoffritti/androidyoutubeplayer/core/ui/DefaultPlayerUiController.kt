...
internal class DefaultPlayerUiController(
    ...
    private val imageViewClear: ImageView
    ...
    init {
        ...
        imageViewClear = controlsView.findViewById(R.id.imageViewClear)
    ...
    private fun initClickListeners() {
        ...
        customActionLeft.setOnClickListener {
            SharePreference.CHANGE="PREVIOUS"
            onPlayButtonPressed()
        }
...
//            if (isPlayPauseButtonEnabled) customActionLeft.visibility = View.VISIBLE
//            if (isPlayPauseButtonEnabled) customActionRight.visibility = View.VISIBLE
